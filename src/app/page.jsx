...
export default function Home() {
  ...
  var[empate, setEmpate] = useState(false)
  const Ganador = () => {
  ...
  const handlePuntosEquipo1 = () =>{ 
    if (CountEquipo1 === 24 && CountEquipo2 === 24) {
      // Si ambos equipos están empatados en 24, el conteo sigue
      setCountEquipo1(CountEquipo1++);
    // } else if (CountEquipo1 === 24 && CountEquipo2 < 24) {
    //   // Si el equipo 1 tiene 24 puntos y el equipo 2 tiene menos de 24, el equipo 1 gana el set
    //   setSeet1("Equipo1");
    //   setCountEquipo1(0);
    //   setCountEquipo2(0);
    } else if (CountEquipo1 > 24 && CountEquipo1 - CountEquipo2 >= 2) {
      // Si el equipo 1 tiene al menos 2 puntos más que el equipo 2, el equipo 1 gana el set
      setSeet1("Equipo1");
      setCountEquipo1(0);
      setCountEquipo2(0);
    } else {
      // Incrementa el contador normalmente
  ...
  const handleMasEquipo2=()=>{
    if (CountEquipo2 === 24 && CountEquipo1 === 24) {
      // Si ambos equipos están empatados en 24, el conteo sigue
      setCountEquipo2(CountEquipo2++);
    } else if (CountEquipo2 === 24 && CountEquipo1 < 24) {
      // Si el equipo 2 tiene 24 puntos y el equipo 1 tiene menos de 24, el equipo 2 gana el set
      setSeet1("Equipo2");
      setCountEquipo1(0);
      setCountEquipo2(0);
    } else if (CountEquipo2 > 24 && CountEquipo2 - CountEquipo1 >= 2) {
      // Si el equipo 2 tiene al menos 2 puntos más que el equipo 1, el equipo 2 gana el set
      setSeet1("Equipo2");
      setCountEquipo1(0);
      setCountEquipo2(0);
    } else {
